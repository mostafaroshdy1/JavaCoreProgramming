...
public class InMemoryWorldDao implements WorldDao {
	...
	public static void main(String args[]) {
		...
		*/
    //allCities.values().forEach(city->System.out.println(city.getCountryCode()));
    //allCountries.values().forEach(country->System.out.println(allCities.values().filter(city->city.getCountryCode()=country.getCode())));
		Analyzer.topPopulatedCityOfEachCountry(allCountries,allCities);
		//Analyzer.topPopulatedCityOfEachContinent(allCountries,allCities);
		//Analyzer.topPopulatedCapital(allCountries,allCities);
		}
